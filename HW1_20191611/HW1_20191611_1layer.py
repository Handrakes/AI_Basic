...
for epoch in range(epochs):
    ...
    for batch in range(4):
        ...
        loss = np.square(np.subtract(net1, ans)).mean()
        ...
        #####
        error_output = ans - net1
        d_output = error_output * net1 * (1 - net1) 
...
#        delta_b2 = 
        ...
        #delta_b2 -= d_output
        delta_W1 -= np.outer(xin, d_output)
        delta_b1 -= d_output
...
for idx in range(4):
    ...
    pred = net1[0][0] # ans와 가까울 수록 잘 학습된 것을 의미합니다.
...
# 학번에 자신의 학번으로 대체해 주세요.
    ...
    #layer 1개인 경우
np.savetxt("20191611_weight_layer1",(W1, b1),fmt="%s")

    #layer 2개인 경우
#np.savetxt("/Users/handrakes/인공지능개론/학번_weight_layer2",(W1, W2, b1, b2),fmt="%s")